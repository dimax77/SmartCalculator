...
fun PrimeScreen(viewmodel: PrimeViewModel = PrimeViewModel()) {
    AppLogger.log(AppLogger.LogLevel.INFO, "Prime Screen", "Started")
    ...
    Column(
        ...
        Button(onClick = {
            AppLogger.log(AppLogger.LogLevel.DEBUG, "Prime Screen", "Button Pressed")
            result = viewmodel.processNumber(number, reverseFlag)
            AppLogger.log(AppLogger.LogLevel.DEBUG, "Result", result.toString())
        }) {
